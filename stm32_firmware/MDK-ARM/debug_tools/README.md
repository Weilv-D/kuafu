...
- `g_imu` (0x20000230) — BMI088_t (0x34): accel[3]@0x04, gyro[3]@0x10, temp@0x1c,
  health@0x20, init state@0x30
- `g_mahony` (0x20000264) — MahonyFilter_t (0x30): roll@0x24, pitch@0x28, yaw@0x2c
- `g_safety_state` (0x20000610) — SafetyState_t (0x1c): mode@0, timer@4,
  fault_mask@8, gyro_offset[3]@0xc, is_calib@0x18
- `g_servos[4]` (0x20000308) — ST3215_State_t[4], stride 0x28: position_tick@0x02,
