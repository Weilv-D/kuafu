...
# ============================================================
MC = 0.698              # cart-pole cart 质量 kg（轮 DDSM315）
MP = 1.981              # cart-pole pendulum 质量 kg（机身 + 舵机 + 电子件 + 腿 + 甲板）
LP = 0.0805             # pendulum 质心高 m（驻留 COM 80.5mm，轮轴以上）
...
LQR_K = np.array([-4.47, -62.47, -5.92, -4.87])
OMEGA_N = 14.32         # 不稳定自然频率 rad/s（周期 0.44 s，摔倒 ~70 ms）
